...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
...
#line 70  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
__inline static int pl_vendor_req(struct usbnet *dev, u8 req, u8 val, u8 index)
{
  int tmp;
  
#line 72 
  tmp = usbnet_read_cmd(dev,(unsigned char)((int)req),(unsigned char)192,(unsigned short)((int)val),(unsigned short)((int)index),(void *)0,(unsigned short)0);
...
#line 85  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
__inline static int pl_set_QuickLink_features(struct usbnet *dev, int val)
{
  int tmp;
  
#line 87 
  tmp = pl_vendor_req(dev,(unsigned char)3,(unsigned char)((int)((unsigned char)val)),(unsigned char)0);
...
#line 90  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
...
#line 100 
      struct _ddebug descriptor = {.modname = "plusb", .function = "pl_reset", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c", .format = "pl_reset --> %d\n", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))100U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
      
#line 100 
      if ((long)(((int)descriptor.flags & 1) != 0) != 0L) 
#line 100 
                                                          __dynamic_netdev_dbg(& descriptor,(struct net_device const *)dev->net,"pl_reset --> %d\n",status); else ;
    }
    else ;
  }
  else ;
...
#line 104  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
static struct driver_info const prolific_info = {.description = (char *)"Prolific PL-2301/PL-2302/PL-25A1", .flags = 4112, .bind = (int (*)(struct usbnet *, struct usb_interface *))0, .unbind = (void (*)(struct usbnet *, struct usb_interface *))0, .reset = & pl_reset, .stop = (int (*)(struct usbnet *))0, .check_connect = (int (*)(struct usbnet *))0, .manage_power = (int (*)(struct usbnet *, int ))0, .status = (void (*)(struct usbnet *, struct urb *))0, .link_reset = (int (*)(struct usbnet *))0, .rx_fixup = (int (*)(struct usbnet *, struct sk_buff *))0, .tx_fixup = (struct sk_buff *(*)(struct usbnet *, struct sk_buff *, gfp_t ))0, .recover = (void (*)(struct usbnet *))0, .early_init = (int (*)(struct usbnet *))0, .indication = (void (*)(struct usbnet *, void *, int ))0, .set_rx_mode = (void (*)(struct usbnet *))0, .in = 0, .out = 0, .data = 0UL};

#line 119  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
static struct usb_device_id const products[6U] = {{.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1659U, .idProduct = (unsigned short)0U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = (unsigned long)(& prolific_info)}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1659U, .idProduct = (unsigned short)1U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = (unsigned long)(& prolific_info)}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1659U, .idProduct = (unsigned short)9633U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = (unsigned long)(& prolific_info)}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1293U, .idProduct = (unsigned short)9610U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = (unsigned long)(& prolific_info)}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)14627U, .idProduct = (unsigned short)30757U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = (unsigned long)(& prolific_info)}, {.match_flags = (unsigned short)0, .idVendor = (unsigned short)0, .idProduct = (unsigned short)0, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = 0UL}};

#line 146  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
struct usb_device_id const __mod_usb__products_device_table[6U];

#line 148  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
static struct usb_driver plusb_driver = {.name = "plusb", .probe = & usbnet_probe, .disconnect = & usbnet_disconnect, .unlocked_ioctl = (int (*)(struct usb_interface *, unsigned int , void *))0, .suspend = & usbnet_suspend, .resume = & usbnet_resume, .reset_resume = (int (*)(struct usb_interface *))0, .pre_reset = (int (*)(struct usb_interface *))0, .post_reset = (int (*)(struct usb_interface *))0, .id_table = (struct usb_device_id const *)(& products), .dynids = {.lock = {.__anonCompField_spinlock_18 = {.rlock = {.raw_lock = {.val = {.counter = 0}}, .magic = 0U, .owner_cpu = 0U, .owner = (void *)0, .dep_map = {.key = (struct lock_class_key *)0, .class_cache = {(struct lock_class *)0, (struct lock_class *)0}, .name = (char const *)0, .cpu = 0, .ip = 0UL}}}}, .list = {.next = (struct list_head *)0, .prev = (struct list_head *)0}}, .drvwrap = {.driver = {.name = (char const *)0, .bus = (struct bus_type *)0, .owner = (struct module *)0, .mod_name = (char const *)0, .suppress_bind_attrs = (_Bool)0, .probe_type = 0, .of_match_table = (struct of_device_id const *)0, .acpi_match_table = (struct acpi_device_id const *)0, .probe = (int (*)(struct device *))0, .remove = (int (*)(struct device *))0, .shutdown = (void (*)(struct device *))0, .suspend = (int (*)(struct device *, pm_message_t ))0, .resume = (int (*)(struct device *))0, .groups = (struct attribute_group const **)0, .pm = (struct dev_pm_ops const *)0, .p = (struct driver_private *)0}, .for_devices = 0}, .no_dynamic_id = 0U, .supports_autosuspend = 0U, .disable_hub_initiated_lpm = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(1))))1U, .soft_unbind = 0U};

#line 158  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/plusb.c"
static int plusb_driver_init(void)
{
  int tmp;
  
#line 158 
  tmp = ldv_usb_register_driver_72(& plusb_driver,& __this_module,"plusb");
...
#line 158 
  ldv_usb_deregister_73(& plusb_driver);
...
#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
int (*ldv_emg_alias_usbnet_resume_2)(struct usb_interface *) = & usbnet_resume;

#line 57  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
int (*ldv_emg_alias_usbnet_suspend_3)(struct usb_interface *, struct pm_message ) = & usbnet_suspend;

#line 58  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
struct usb_driver *ldv_emg_alias_plusb_driver_2 = & plusb_driver;

#line 59  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
void (*ldv_emg_alias_usbnet_disconnect_4)(struct usb_interface *) = & usbnet_disconnect;

#line 60  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
...
#line 68  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
void ldv_emg_plusb_driver_exit(void)
{
...
#line 72  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
int ldv_emg_plusb_driver_init(void)
{
  int tmp;
  
#line 73 
  tmp = plusb_driver_init();
...
#line 747  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
static int ldv_usb_register_driver_72(struct usb_driver *ldv_func_arg1, struct module *ldv_func_arg2, char const *ldv_func_arg3)
{
  int tmp;
...
#line 755  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/weaver/.tmp_plusb.c.aux"
static void ldv_usb_deregister_73(struct usb_driver *ldv_func_arg1)
{
...
#line 26  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
...
#line 35  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
pthread_t ldv_thread_4;

#line 39  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_register_3_3(struct usb_driver *arg0)
{
  int ret;
...
#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 69  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
int ldv_emg_usb_register_driver(struct usb_driver *arg0, struct module *arg1, char *arg2)
{
  int __retres;
  int tmp_0;
...
#line 72 
  struct usb_driver *ldv_3_usb_driver = ldv_emg_alias_plusb_driver_2;
...
#line 104  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_usb_scenario_4(void *arg0)
{
  void *__retres;
...
#line 110 
  struct usb_driver *ldv_4_container = ldv_emg_alias_plusb_driver_2;
...
#line 289  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_deregister_2_1(struct usb_driver *arg0)
{
  int ret;
  struct ldv_struct_usb_scenario_4 *cf_arg_4;
...
#line 304  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_emg_usb_deregister(struct usb_driver *arg0)
{
  
#line 307 
  struct usb_driver *ldv_2_usb_driver = ldv_emg_alias_plusb_driver_2;
...
#line 325  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/plusb.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;
...
#line 332 
  ldv_1_ret = ldv_emg_plusb_driver_init();

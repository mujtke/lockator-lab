...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
...
#line 232  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can.h"
struct c_can_pci_data {
   enum c_can_dev_id type ;
   enum c_can_pci_reg_align reg_align ;
   unsigned int freq ;
   int bar ;
   void (*init)(struct c_can_priv const *, bool ) ;
};
...
#line 7  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/fvtp/.tmp_c_can_pci.c"
...
#line 50  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static u16 c_can_pci_read_reg_aligned_to_16bit(struct c_can_priv const *priv, enum reg index)
{
  u16 tmp;
...
#line 56  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static void c_can_pci_write_reg_aligned_to_16bit(struct c_can_priv const *priv, enum reg index, u16 val)
{
...
#line 62  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static u16 c_can_pci_read_reg_aligned_to_32bit(struct c_can_priv const *priv, enum reg index)
{
  u16 tmp;
...
#line 68  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static void c_can_pci_write_reg_aligned_to_32bit(struct c_can_priv const *priv, enum reg index, u16 val)
{
...
#line 74  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static u16 c_can_pci_read_reg_32bit(struct c_can_priv const *priv, enum reg index)
{
  u16 __retres;
  unsigned int tmp;
  
#line 77 
  tmp = ioread32(priv->base + (int)*(priv->regs + index) * 2);
...
#line 80  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static void c_can_pci_write_reg_32bit(struct c_can_priv const *priv, enum reg index, u16 val)
{
  
#line 83 
  iowrite32((unsigned int)val,priv->base + (int)*(priv->regs + index) * 2);
...
#line 86  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static u32 c_can_pci_read_reg32(struct c_can_priv const *priv, enum reg index)
{
  u32 val;
  u16 tmp;
  u16 tmp_0;
...
#line 96  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static void c_can_pci_write_reg32(struct c_can_priv const *priv, enum reg index, u32 val)
{
...
#line 103  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static void c_can_pci_reset_pch(struct c_can_priv const *priv, bool enable)
{
...
#line 114  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static int c_can_pci_probe(struct pci_dev *pdev, struct pci_device_id const *ent)
{
  int __retres;
...
#line 129 
  ret = pci_request_regions(pdev,"c_can_pci");
...
#line 137 
    _dev_info((struct device const *)(& pdev->dev),"MSI enabled\n");
...
#line 142 
    tmp = (pdev->resource[c_can_pci_data->bar].end - pdev->resource[c_can_pci_data->bar].start) + 1ULL; else 
...
#line 141 
  addr = pci_iomap(pdev,c_can_pci_data->bar,(unsigned long)tmp);
  
#line 143 
  if (addr == (void *)0) {
    
#line 144 
    dev_err((struct device const *)(& pdev->dev),"device has no PCI memory resources, ");
...
#line 166 
    dev_err((struct device const *)(& pdev->dev),"no clock frequency defined\n");
...
#line 219 
    struct _ddebug descriptor = {.modname = "c_can_pci", .function = "c_can_pci_probe", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c", .format = "%s device registered (regs=%p, irq=%d)\n", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))220U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))1U};
    
#line 219 
    if ((long)(((int)descriptor.flags & 1) != 0) != 0L) 
#line 219 
                                                        __dynamic_dev_dbg(& descriptor,(struct device const *)(& pdev->dev),"%s device registered (regs=%p, irq=%d)\n",(char *)"c_can_pci",priv->regs,dev->irq); else ;
  }
...
#line 238  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
...
#line 241 
  struct c_can_priv *priv = netdev_priv((struct net_device const *)dev);
...
#line 254  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static struct c_can_pci_data c_can_sta2x11 = {.type = BOSCH_C_CAN, .reg_align = C_CAN_REG_ALIGN_32, .freq = 52000000U, .bar = 0, .init = (void (*)(struct c_can_priv const *, bool ))0};

#line 261  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
...
#line 274  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static struct pci_device_id const c_can_pci_tbl[3U] = {{.vendor = 4170U, .device = 52241U, .subvendor = 4294967295U, .subdevice = 4294967295U, .class = 0U, .class_mask = 0U, .driver_data = (unsigned long)(& c_can_sta2x11)}, {.vendor = 32902U, .device = 34840U, .subvendor = 4294967295U, .subdevice = 4294967295U, .class = 0U, .class_mask = 0U, .driver_data = (unsigned long)(& c_can_pch)}, {.vendor = 0U, .device = 0U, .subvendor = 0U, .subdevice = 0U, .class = 0U, .class_mask = 0U, .driver_data = 0UL}};

#line 281  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static struct pci_driver c_can_pci_driver = {.node = {.next = (struct list_head *)0, .prev = (struct list_head *)0}, .name = "c_can_pci", .id_table = (struct pci_device_id const *)(& c_can_pci_tbl), .probe = & c_can_pci_probe, .remove = & c_can_pci_remove, .suspend = (int (*)(struct pci_dev *, pm_message_t ))0, .suspend_late = (int (*)(struct pci_dev *, pm_message_t ))0, .resume_early = (int (*)(struct pci_dev *))0, .resume = (int (*)(struct pci_dev *))0, .shutdown = (void (*)(struct pci_dev *))0, .sriov_configure = (int (*)(struct pci_dev *, int ))0, .err_handler = (struct pci_error_handlers const *)0, .driver = {.name = (char const *)0, .bus = (struct bus_type *)0, .owner = (struct module *)0, .mod_name = (char const *)0, .suppress_bind_attrs = (_Bool)0, .probe_type = 0, .of_match_table = (struct of_device_id const *)0, .acpi_match_table = (struct acpi_device_id const *)0, .probe = (int (*)(struct device *))0, .remove = (int (*)(struct device *))0, .shutdown = (void (*)(struct device *))0, .suspend = (int (*)(struct device *, pm_message_t ))0, .resume = (int (*)(struct device *))0, .groups = (struct attribute_group const **)0, .pm = (struct dev_pm_ops const *)0, .p = (struct driver_private *)0}, .dynids = {.lock = {.__anonCompField_spinlock_18 = {.rlock = {.raw_lock = {.val = {.counter = 0}}, .magic = 0U, .owner_cpu = 0U, .owner = (void *)0, .dep_map = {.key = (struct lock_class_key *)0, .class_cache = {(struct lock_class *)0, (struct lock_class *)0}, .name = (char const *)0, .cpu = 0, .ip = 0UL}}}}, .list = {.next = (struct list_head *)0, .prev = (struct list_head *)0}}};

#line 288  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
static int c_can_pci_driver_init(void)
{
  int tmp;
  
#line 288 
  tmp = ldv___pci_register_driver_72(& c_can_pci_driver,& __this_module,"c_can_pci");
...
#line 288 
  ldv_pci_unregister_driver_73(& c_can_pci_driver);
...
#line 293  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/can/c_can/c_can_pci.c"
struct pci_device_id const __mod_pci__c_can_pci_tbl_device_table[3U];

#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
struct pci_driver *ldv_emg_alias_c_can_pci_driver_2 = & c_can_pci_driver;
...
#line 64  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
void ldv_emg_wrapper_c_can_pci_remove_3(struct pci_dev *arg0)
{
...
#line 69  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
void ldv_emg_c_can_pci_driver_exit(void)
{
...
#line 73  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
int ldv_emg_c_can_pci_driver_init(void)
{
  int tmp;
  
#line 74 
  tmp = c_can_pci_driver_init();
...
#line 77  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
int ldv_emg_wrapper_c_can_pci_probe_2(struct pci_dev *arg0, struct pci_device_id *arg1)
{
  int tmp;
  
#line 78 
  tmp = c_can_pci_probe(arg0,(struct pci_device_id const *)arg1);
...
#line 753  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
static int ldv___pci_register_driver_72(struct pci_driver *ldv_func_arg1, struct module *ldv_func_arg2, char const *ldv_func_arg3)
{
  int tmp;
...
#line 761  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/weaver/.tmp_c_can_pci.c.aux"
static void ldv_pci_unregister_driver_73(struct pci_driver *ldv_func_arg1)
{
...
#line 25  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
int main(void);
...
#line 34  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
pthread_t ldv_thread_4;

#line 38  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 51  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_deregister_3_1(struct pci_driver *arg0)
{
  int ret;
...
#line 66  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
int ldv_emg___pci_register_driver(struct pci_driver *arg0, struct module *arg1, char *arg2)
{
  int __retres;
  int tmp_0;
...
#line 69 
  struct pci_driver *ldv_2_pci_driver = ldv_emg_alias_c_can_pci_driver_2;
...
#line 100  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_emg_pci_unregister_driver(struct pci_driver *arg0)
{
  
#line 103 
  struct pci_driver *ldv_3_pci_driver = ldv_emg_alias_c_can_pci_driver_2;
...
#line 121  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_register_2_3(struct pci_driver *arg0)
{
  int ret;
  struct ldv_struct_pci_scenario_4 *cf_arg_4;
...
#line 138  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_pci_scenario_4(void *arg0)
{
  void *__retres;
...
#line 143 
  struct pci_driver *ldv_4_container = ldv_emg_alias_c_can_pci_driver_2;
...
#line 184 
    ldv_4_ret = ldv_emg_wrapper_c_can_pci_probe_2(ldv_4_resource_1,ldv_4_ldv_param_1_2);
...
#line 301 
    ldv_emg_wrapper_c_can_pci_remove_3(ldv_4_resource_1);
...
#line 319  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/can/c_can/c_can_pci.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;
...
#line 326 
  ldv_1_ret = ldv_emg_c_can_pci_driver_init();

...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/arcnet/rfc1201.ko/linux:concurrency safety/weaver/.tmp_rfc1201.c.aux"
...
struct __anonstruct_kuid_t_140 {
   uid_t val ;
};

#line 22  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/include/linux/uidgid.h"
typedef struct __anonstruct_kuid_t_140 kuid_t;

#line 27  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/include/linux/uidgid.h"
struct __anonstruct_kgid_t_141 {
   gid_t val ;
};

#line 27  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/include/linux/uidgid.h"
typedef struct __anonstruct_kgid_t_141 kgid_t;
...
#line 38  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
...
#line 47  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
static struct ArcProto rfc1201_proto = {.suffix = (char)97, .mtu = 1500, .is_ip = 1, .rx = & rx, .build_header = & build_header, .prepare_tx = & prepare_tx, .continue_tx = & continue_tx, .ack_tx = (int (*)(struct net_device *, int ))0};

#line 60  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
...
#line 74 
                                            arc_bcast_proto = & rfc1201_proto; else ;
...
#line 79  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
...
#line 92  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
static __be16 type_trans(struct sk_buff *skb, struct net_device *dev)
{
  __be16 __retres;
...
#line 118 
    __retres = (unsigned short)13696U;
...
#line 134  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
static void rx(struct net_device *dev, int bufnum, struct archdr *pkthdr, int length)
{
  struct sk_buff *skb;
  int ofs;
...
#line 155 
      if ((arcnet_debug & 2) != 0) 
#line 155 
                                   printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),saddr); else ;
...
#line 171 
      if ((arcnet_debug & 2) != 0) 
#line 171 
                                   printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),(int)in->sequence,(int)soft->split_flag,(int)soft->sequence); else ;
...
#line 181 
    skb = alloc_skb((unsigned int)(length + 4),32U);
...
#line 194 
    memcpy((void *)pkt,(void const *)pkthdr,20UL);
    
#line 195 
    if ((unsigned int)length > 16U) 
#line 196 
                                    (*(lp->hw.copy_from_card))(dev,bufnum,(int)((unsigned int)ofs + 16U),(void *)(& pkt->soft.raw) + 16U,(int)((unsigned int)length + 4294967280U)); else ;
...
#line 223 
        if ((arcnet_debug & 1) != 0) 
#line 223 
                                     printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),(int)arp->ar_hln,(int)arp->ar_pln); else ;
...
#line 255 
      if ((arcnet_debug & 2) != 0) 
#line 255 
                                   printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),saddr,(int)in->sequence,(int)soft->sequence,(int)soft->split_flag); else ;
...
#line 281 
        if ((arcnet_debug & 2) != 0) 
#line 281 
                                     printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),(int)soft->split_flag); else ;
...
#line 288 
      skb = alloc_skb((unsigned int)((int)in->numpackets * 508 + 4),32U);
...
#line 300 
      memcpy((void *)pkt,(void const *)pkthdr,8UL);
...
#line 313 
          if ((arcnet_debug & 2) != 0) 
#line 313 
                                       printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),(int)soft->split_flag,(int)soft->sequence,(int)lp->rfc1201.aborted_seq); else ;
...
#line 350 
    (*(lp->hw.copy_from_card))(dev,bufnum,ofs + 4,(void *)(skb->data + skb->len),length + -4);
...
#line 374  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
static int build_header(struct sk_buff *skb, struct net_device *dev, unsigned short type, uint8_t daddr)
{
  int __retres;
  __u16 tmp_2;
...
#line 405 
    if ((arcnet_debug & 1) != 0) 
#line 405 
                                 printk("%s%6s: ",(char *)"\001",(char *)(& dev->name),(int)type,(int)type); else ;
...
#line 441  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
...
#line 474  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
static int prepare_tx(struct net_device *dev, struct archdr *pkt, int length, int bufnum)
{
  int __retres;
  struct Outgoing *out;
...
#line 510  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/arcnet/rfc1201.c"
static int continue_tx(struct net_device *dev, int bufnum)
{
  int __retres;
...
#line 524 
  newsoft = (struct arc_rfc1201 *)(& (out->pkt)->soft.raw) + ((int)out->length + - ((int)out->dataleft));
...
#line 57  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/arcnet/rfc1201.ko/linux:concurrency safety/weaver/.tmp_rfc1201.c.aux"
void ldv_emg_arcnet_rfc1201_exit(void)
{
...
#line 61  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/arcnet/rfc1201.ko/linux:concurrency safety/weaver/.tmp_rfc1201.c.aux"
int ldv_emg_arcnet_rfc1201_init(void)
{
  int tmp;
...
#line 15  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/arcnet/rfc1201.ko/linux:concurrency safety/emg/environment_model.c"
int main(void);
...
#line 20  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/arcnet/rfc1201.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 33  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/arcnet/rfc1201.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;
...
#line 40 
  ldv_1_ret = ldv_emg_arcnet_rfc1201_init();

...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
...
#line 60  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c"
...
#line 66 
    struct _ddebug descriptor = {.modname = "kalmia", .function = "kalmia_send_init_packet", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Sending init packet", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))66U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
    
#line 66 
    if ((long)(((int)descriptor.flags & 1) != 0) != 0L) 
#line 66 
                                                        __dynamic_netdev_dbg(& descriptor,(struct net_device const *)dev->net,"Sending init packet"); else ;
  }
...
#line 68 
  status = usb_bulk_msg(dev->udev,tmp | 3221225472U,(void *)init_msg,(int)init_msg_len,& act_len,10000);
  
#line 70 
  if (status != 0) {
    
#line 71 
    netdev_err((struct net_device const *)dev->net,"Error sending init packet. Status %i, length %i\n",status,act_len);
...
#line 77 
                                      netdev_err((struct net_device const *)dev->net,"Did not send all of init packet. Bytes sent: %i",act_len);
    else {
      
#line 82 
      struct _ddebug descriptor_0 = {.modname = "kalmia", .function = "kalmia_send_init_packet", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Successfully sent init packet.", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))82U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
      
#line 82 
      if ((long)(((int)descriptor_0.flags & 1) != 0) != 0L) 
#line 82 
                                                            __dynamic_netdev_dbg(& descriptor_0,(struct net_device const *)dev->net,"Successfully sent init packet."); else ;
    }
...
#line 85 
  tmp_0 = __create_pipe(dev->udev,129U);
  
#line 85 
  ;
  
#line 85 
  status = usb_bulk_msg(dev->udev,tmp_0 | 3221225600U,(void *)buffer,(int)expected_len,& act_len,10000);
  
#line 88 
  if (status != 0) 
#line 89 
                   netdev_err((struct net_device const *)dev->net,"Error receiving init result. Status %i, length %i\n",status,act_len);
  else 
    
#line 92 
    if ((int)expected_len != act_len) 
#line 93 
                                      netdev_err((struct net_device const *)dev->net,"Unexpected init result length: %i\n",act_len); else ;
...
#line 100  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c"
...
#line 102 
  char const init_msg_1[12U] = {(char)87, (char)80, (char)4, (char)0, (char)0, (char)0, (char)0, (char)32, (char)0, (char)0, (char)0, (char)0};
  
#line 105 
  char const init_msg_2[12U] = {(char)87, (char)80, (char)4, (char)0, (char)0, (char)0, (char)0, (char)2, (char)0, (char)(-12), (char)0, (char)0};
  
#line 108 
  int const buflen = 28;
  
#line 112 
  usb_buf = (char *)kmalloc((unsigned long)buflen,209U);
...
#line 116 
  memcpy((void *)usb_buf,(void const *)(& init_msg_1),12UL);
...
#line 122 
  memcpy((void *)usb_buf,(void const *)(& init_msg_2),12UL);
...
#line 128 
  memcpy((void *)ethernet_addr,(void const *)(usb_buf + 10U),6UL);
  
#line 130 
  kfree((void const *)usb_buf);
...
#line 135  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c"
...
#line 156 
    tmp_1 = driver_of(intf);
    
#line 156 
    usb_driver_release_interface(tmp_1,intf);
...
#line 160 
  memcpy((void *)(dev->net)->dev_addr,(void const *)(& ethernet_addr),6UL);
...
#line 166  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c"
...
#line 191 
  skb2 = skb_copy_expand((struct sk_buff const *)skb,6,4,flags);
...
#line 204 
    struct _ddebug descriptor = {.modname = "kalmia", .function = "kalmia_tx_fixup", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Sending etherType: %02x%02x", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))205U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
    
#line 204 
    if ((long)(((int)descriptor.flags & 1) != 0) != 0L) 
#line 204 
                                                        __dynamic_netdev_dbg(& descriptor,(struct net_device const *)dev->net,"Sending etherType: %02x%02x",(int)ether_type_1,(int)ether_type_2); else ;
  }
...
#line 220 
    tmp_3 = skb_put(skb,(unsigned int)padlen);
    
#line 220 
    memset((void *)tmp_3,0,(unsigned long)padlen);
  }
  else ;
  {
    
#line 223 
    struct _ddebug descriptor_0 = {.modname = "kalmia", .function = "kalmia_tx_fixup", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Sending package with length %i and padding %i. Header: %6phC.", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))225U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
    
#line 223 
    if ((long)(((int)descriptor_0.flags & 1) != 0) != 0L) 
#line 223 
                                                          __dynamic_netdev_dbg(& descriptor_0,(struct net_device const *)dev->net,"Sending package with length %i and padding %i. Header: %6phC.",(int)content_len,(int)padlen,header_start); else ;
  }
...
#line 231  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c"
static int kalmia_rx_fixup(struct usbnet *dev, struct sk_buff *skb)
{
  int __retres;
  
#line 237 
  u8 const HEADER_END_OF_USB_PACKET[6U] = {(unsigned char)87U, (unsigned char)90U, (unsigned char)0U, (unsigned char)0U, (unsigned char)8U, (unsigned char)0U};
  
#line 239 
  u8 const EXPECTED_UNKNOWN_HEADER_1[6U] = {(unsigned char)87U, (unsigned char)67U, (unsigned char)30U, (unsigned char)0U, (unsigned char)21U, (unsigned char)2U};
  
#line 241 
  u8 const EXPECTED_UNKNOWN_HEADER_2[6U] = {(unsigned char)87U, (unsigned char)80U, (unsigned char)14U, (unsigned char)0U, (unsigned char)0U, (unsigned char)0U};
...
#line 258 
      tmp = memcmp((void const *)header_start,(void const *)(& EXPECTED_UNKNOWN_HEADER_1),6UL);
...
#line 259 
        tmp_0 = memcmp((void const *)header_start,(void const *)(& EXPECTED_UNKNOWN_HEADER_2),6UL);
...
#line 262 
                  struct _ddebug descriptor = {.modname = "kalmia", .function = "kalmia_rx_fixup", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Received expected unknown frame header: %6phC. Package length: %i\n", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))265U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
                  
#line 262 
                  if ((long)(((int)descriptor.flags & 1) != 0) != 0L) 
                    
#line 262 
                    __dynamic_netdev_dbg(& descriptor,(struct net_device const *)dev->net,"Received expected unknown frame header: %6phC. Package length: %i\n",header_start,skb->len + 4294967290U); else ;
                }
        }
        else {
          
#line 268 
          netdev_err((struct net_device const *)dev->net,"Received unknown frame header: %6phC. Package length: %i\n",header_start,skb->len + 4294967290U);
...
#line 276 
      struct _ddebug descriptor_0 = {.modname = "kalmia", .function = "kalmia_rx_fixup", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Received header: %6phC. Package length: %i\n", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))278U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
      
#line 276 
      if ((long)(((int)descriptor_0.flags & 1) != 0) != 0L) 
#line 276 
                                                            __dynamic_netdev_dbg(& descriptor_0,(struct net_device const *)dev->net,"Received header: %6phC. Package length: %i\n",header_start,skb->len + 4294967290U); else ;
    }
...
#line 282 
    ether_packet_length = get_unaligned_le16((void const *)(header_start + 2U));
...
#line 292 
        struct _ddebug descriptor_1 = {.modname = "kalmia", .function = "kalmia_rx_fixup", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "Correct package length #%i", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))293U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
        
#line 292 
        if ((long)(((int)descriptor_1.flags & 1) != 0) != 0L) 
#line 292 
                                                              __dynamic_netdev_dbg(& descriptor_1,(struct net_device const *)dev->net,"Correct package length #%i",i + 1); else ;
      }
      
#line 295 
      tmp_1 = memcmp((void const *)(skb->data + (int)ether_packet_length),(void const *)(& HEADER_END_OF_USB_PACKET),6UL);
...
#line 299 
        header_start = skb->data + (int)ether_packet_length;
        {
          
#line 300 
          struct _ddebug descriptor_2 = {.modname = "kalmia", .function = "kalmia_rx_fixup", .filename = "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/kalmia.c", .format = "End header: %6phC. Package length: %i\n", .lineno = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(18))))303U, .flags = (unsigned int __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))))0U};
          
#line 300 
          if ((long)(((int)descriptor_2.flags & 1) != 0) != 0L) 
#line 300 
                                                                __dynamic_netdev_dbg(& descriptor_2,(struct net_device const *)dev->net,"End header: %6phC. Package length: %i\n",header_start,skb->len + 4294967290U); else ;
        }
      }
      else ;
    }
...
#line 362 
  ldv_usb_deregister_73(& kalmia_driver);
...
#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
int (*ldv_emg_alias_usbnet_suspend_3)(struct usb_interface *, struct pm_message ) = & usbnet_suspend;

#line 57  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
struct usb_driver *ldv_emg_alias_kalmia_driver_2 = & kalmia_driver;

#line 58  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
int (*ldv_emg_alias_usbnet_resume_2)(struct usb_interface *) = & usbnet_resume;

#line 59  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
void (*ldv_emg_alias_usbnet_disconnect_4)(struct usb_interface *) = & usbnet_disconnect;

#line 60  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
...
#line 68  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
int ldv_emg_kalmia_driver_init(void)
{
  int tmp;
  
#line 69 
  tmp = kalmia_driver_init();
...
#line 72  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
void ldv_emg_kalmia_driver_exit(void)
{
...
#line 586  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
static void *kmalloc(size_t size, gfp_t flags)
{
  void *tmp;
...
#line 747  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
static int ldv_usb_register_driver_72(struct usb_driver *ldv_func_arg1, struct module *ldv_func_arg2, char const *ldv_func_arg3)
{
  int tmp;
...
#line 755  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/weaver/.tmp_kalmia.c.aux"
static void ldv_usb_deregister_73(struct usb_driver *ldv_func_arg1)
{
...
#line 26  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
...
#line 35  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
pthread_t ldv_thread_4;

#line 39  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_register_3_3(struct usb_driver *arg0)
{
  int ret;
...
#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 69  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
int ldv_emg_usb_register_driver(struct usb_driver *arg0, struct module *arg1, char *arg2)
{
  int __retres;
  int tmp_0;
...
#line 72 
  struct usb_driver *ldv_3_usb_driver = ldv_emg_alias_kalmia_driver_2;
...
#line 104  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_usb_scenario_4(void *arg0)
{
  void *__retres;
...
#line 110 
  struct usb_driver *ldv_4_container = ldv_emg_alias_kalmia_driver_2;
...
#line 289  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_deregister_2_1(struct usb_driver *arg0)
{
  int ret;
  struct ldv_struct_usb_scenario_4 *cf_arg_4;
...
#line 304  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_emg_usb_deregister(struct usb_driver *arg0)
{
  
#line 307 
  struct usb_driver *ldv_2_usb_driver = ldv_emg_alias_kalmia_driver_2;
...
#line 325  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/kalmia.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;
...
#line 332 
  ldv_1_ret = ldv_emg_kalmia_driver_init();

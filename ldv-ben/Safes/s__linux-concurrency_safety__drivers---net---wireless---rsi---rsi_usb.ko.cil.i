...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
...
typedef enum ldv_22486 socket_state;
...
struct nf_bridge_info {
   atomic_t use ;
   enum ldv_26121 __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))) orig_proto : 8 ;
   bool pkt_otherhost ;
   __u16 frag_max_size ;
   unsigned int mask ;
...
typedef enum ldv_29176 phy_interface_t;
...
struct net_device {
   ...
   enum ldv_30939 __attribute__((__FRAMA_C_BITFIELD_SIZE__(8))) reg_state : 8 ;
   bool dismantle ;
   enum ldv_30940 __attribute__((__FRAMA_C_BITFIELD_SIZE__(16))) rtnl_link_state : 16 ;
...
#line 87  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_common.h"
struct rsi_91x_usbdev {
   struct rsi_thread rx_thread ;
   u8 endpoint ;
   struct usb_device *usbdev ;
   struct usb_interface *pfunction ;
   struct urb *rx_usb_urb[1U] ;
   u8 *tx_buffer ;
   __le16 bulkin_size ;
...
#line 7  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
...
#line 2434  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/include/linux/sched.h"
...
#line 1173 
static int ldv_usb_register_driver_73(struct usb_driver *ldv_func_arg1, struct module *ldv_func_arg2, char const *ldv_func_arg3);


#line 1183 
static void ldv_usb_deregister_74(struct usb_driver *ldv_func_arg1);
...
#line 43  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_main.h"
void rsi_dbg(u32, char const * , ...);
...
#line 53  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_usb.h"
...
#line 59  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_usb.h"
...
#line 65 
int rsi_usb_write_register_multiple(struct rsi_hw *adapter, u32 addr, u8 *data, u32 count);
...
#line 30  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static int rsi_usb_card_write(struct rsi_hw *adapter, void *buf, u16 len, u8 endpoint)
{
  int status;
  s32 transfer;
  unsigned int tmp;
...
#line 39 
  tmp = __create_pipe(dev->usbdev,(unsigned int)dev->bulkout_endpoint_addr[(int)endpoint + -1]);
  
#line 39 
  ;
  
#line 39 
  status = usb_bulk_msg(dev->usbdev,tmp | 3221225472U,buf,(int)len,& transfer,1250);
  
#line 47 
  if (status < 0) {
    
#line 48 
    rsi_dbg(1U,"Card write failed with error code :%10d\n",status);
...
#line 65  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 76 
  if ((unsigned int)endpoint == 1U) {
    
#line 77 
    memset((void *)seg,0,128UL);
    
#line 78 
    memcpy((void *)(seg + 128U),(void const *)data,(unsigned long)count);
  }
  else 
#line 80 
       seg = data + 18446744073709551488U;
  
#line 83 
  tmp = rsi_usb_card_write(adapter,(void *)seg,(unsigned short)((int)((unsigned int)((unsigned short)count) + 128U)),(unsigned char)((int)endpoint));
...
#line 97  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 111 
  if (((unsigned int)dev->bulkin_endpoint_addr == 0U && (int)endpoint->bEndpointAddress < 0) && ((int)endpoint->bmAttributes & 3) == 2) {
...
#line 118 
    dev->bulkin_endpoint_addr = endpoint->bEndpointAddress;
  }
  else ;
  
#line 122 
  if (((unsigned int)dev->bulkout_endpoint_addr[bep_found] == 0U && (int)endpoint->bEndpointAddress >= 0) && ((int)endpoint->bmAttributes & 3) == 2) {
    
#line 126 
    dev->bulkout_endpoint_addr[bep_found] = endpoint->bEndpointAddress;
...
#line 108 
  if ((int)iface_desc->desc.bNumEndpoints > ii) 
#line 110 
                                                goto ldv_51222; else 
...
#line 137 
  if ((unsigned int)dev->bulkin_endpoint_addr == 0U && (unsigned int)dev->bulkout_endpoint_addr[0] != 0U) {
...
#line 152  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 164 
  status = usb_control_msg(usbdev,tmp_0 | 2147483776U,(unsigned char)21,(unsigned char)64,(unsigned short)((int)((unsigned short)(reg >> 16))),(unsigned short)((int)((unsigned short)reg)),(void *)buf,(unsigned short)((int)len),1250);
...
#line 174 
  if (status < 0) 
#line 175 
                  rsi_dbg(1U,"%s: Reg read failed with error code :%d\n","rsi_usb_reg_read",status); else ;
...
#line 194  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static int rsi_usb_reg_write(struct usb_device *usbdev, u32 reg, u16 value, u16 len)
{
  int __retres;
  u8 *usb_reg_buf;
  unsigned int tmp_0;
...
#line 202 
  usb_reg_buf = (u8 *)kmalloc(4UL,208U);
...
#line 207 
  *(usb_reg_buf + 1U) = (unsigned char)((int)value >> 8);
  
#line 208 
  *(usb_reg_buf + 2U) = (unsigned char)0U;
  
#line 209 
  *(usb_reg_buf + 3U) = (unsigned char)0U;
...
#line 211 
  status = usb_control_msg(usbdev,tmp_0 | 2147483648U,(unsigned char)22,(unsigned char)64,(unsigned short)((int)((unsigned short)(reg >> 16))),(unsigned short)((int)((unsigned short)reg)),(void *)usb_reg_buf,(unsigned short)((int)len),1250);
  
#line 220 
  if (status < 0) 
#line 221 
                  rsi_dbg(1U,"%s: Reg write failed with error code :%d\n","rsi_usb_reg_write",status); else ;
  
#line 225 
  kfree((void const *)usb_reg_buf);
...
#line 237  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static void rsi_rx_done_handler(struct urb *urb)
{
  
#line 239 
  struct rsi_hw *adapter = (struct rsi_hw *)urb->context;
...
#line 254  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 261 
  tmp = __create_pipe(dev->usbdev,(unsigned int)dev->bulkin_endpoint_addr);
...
#line 260 
  usb_fill_bulk_urb(urb,dev->usbdev,tmp | 3221225600U,urb->transfer_buffer,3000,& rsi_rx_done_handler,(void *)adapter);
  
#line 269 
  status = ldv_usb_submit_urb_72(urb,208U);
  
#line 270 
  if (status != 0) 
#line 271 
                   rsi_dbg(1U,"%s: Failed in urb submission\n","rsi_rx_urb_submit"); else ;
...
#line 286  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
int rsi_usb_write_register_multiple(struct rsi_hw *adapter, u32 addr, u8 *data, u32 count)
{
  int __retres;
  u8 *buf;
...
#line 301 
  transfer = (unsigned char)tmp_1;
  
#line 302 
  memcpy((void *)buf,(void const *)data,(unsigned long)transfer);
...
#line 303 
  tmp_2 = __create_pipe(dev->usbdev,0U);
  
#line 303 
  ;
  
#line 303 
  status = usb_control_msg(dev->usbdev,tmp_2 | 2147483648U,(unsigned char)22,(unsigned char)64,(unsigned short)((int)((unsigned short)(addr >> 16))),(unsigned short)((int)((unsigned short)addr)),(void *)buf,(unsigned short)((int)transfer),1250);
  
#line 312 
  if (status < 0) 
#line 313 
                  rsi_dbg(1U,"Reg write failed with error code :%d\n",status);
  else {
    
#line 317 
    count -= (unsigned int)transfer;
...
#line 336  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 340 
  u32 queueno = (unsigned int)((int)*(pkt + 1U) >> 4) & 15U;
...
#line 345 
  tmp = rsi_write_multiple(adapter,(unsigned char)((int)endpoint),pkt,len);
...
#line 357  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 363 
  kfree((void const *)(adapter->priv)->rx_data_pkt);
  
#line 364 
  kfree((void const *)dev->tx_buffer);
...
#line 374  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 381 
  rsi_dev = (struct rsi_91x_usbdev *)kzalloc(296UL,208U);
...
#line 388 
  tmp_0 = rsi_find_bulk_in_and_out_endpoints(pfunction,adapter);
...
#line 394 
  common->rx_data_pkt = (u8 *)kmalloc(2048UL,208U);
  
#line 395 
  if (common->rx_data_pkt == (u8 *)0U) {
    
#line 396 
    rsi_dbg(1U,"%s: Failed to allocate memory\n","rsi_init_usb_interface");
...
#line 401 
  rsi_dev->tx_buffer = (u8 *)kmalloc(2048UL,208U);
...
#line 406 
  rsi_dev->rx_usb_urb[0] = usb_alloc_urb(0,208U);
  
#line 407 
  if (rsi_dev->rx_usb_urb[0] == (struct urb *)0) {
...
#line 411 
  (rsi_dev->rx_usb_urb[0])->transfer_buffer = (void *)(adapter->priv)->rx_data_pkt;
...
#line 421 
  status = rsi_create_kthread(common,& rsi_dev->rx_thread,(void *)(& rsi_usb_rx_thread),(u8 *)"RX-Thread");
  
#line 423 
  if (status != 0) {
    
#line 424 
    rsi_dbg(1U,"%s: Unable to init rx thrd\n","rsi_init_usb_interface");
...
#line 433 
  rsi_dbg(4U,"%s: Enabled the interface\n","rsi_init_usb_interface");
...
#line 439 
  kfree((void const *)rsi_dev->tx_buffer);
  fail_tx: 
#line 440 
  ;
  
#line 441 
  kfree((void const *)common->rx_data_pkt);
...
#line 454  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static int rsi_probe(struct usb_interface *pfunction, struct usb_device_id const *id)
{
  int __retres;
...
#line 462 
  rsi_dbg(4U,"%s: Init function called\n","rsi_probe");
...
#line 466 
    rsi_dbg(1U,"%s: Failed to init os intf ops\n","rsi_probe");
...
#line 473 
    rsi_dbg(1U,"%s: Failed to init usb interface\n","rsi_probe");
...
#line 478 
  rsi_dbg(1U,"%s: Initialized os intf ops\n","rsi_probe");
...
#line 491 
      rsi_dbg(1U,"%s: Failed in device init\n","rsi_probe");
...
#line 496 
    status = rsi_usb_reg_write(dev->usbdev,151552U,(unsigned short)171,(unsigned short)1);
...
#line 501 
    rsi_dbg(4U,"%s: Performed device init\n","rsi_probe");
  }
  else ;
...
#line 513 
  rsi_dbg(1U,"%s: Failed in probe...Exiting\n","rsi_probe");
...
#line 524  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 535 
  rsi_dbg(2U,"%s: Deinitialization completed\n","rsi_disconnect");
  return_label: 
#line 536 
                return;
}
...
#line 539  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 545  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
...
#line 552  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static struct usb_device_id const rsi_dev_table[5U] = {{.match_flags = (unsigned short)3U, .idVendor = (unsigned short)771U, .idProduct = (unsigned short)256U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = 0UL}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1051U, .idProduct = (unsigned short)769U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = 0UL}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1051U, .idProduct = (unsigned short)513U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = 0UL}, {.match_flags = (unsigned short)3U, .idVendor = (unsigned short)1051U, .idProduct = (unsigned short)37680U, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = 0UL}, {.match_flags = (unsigned short)0, .idVendor = (unsigned short)0, .idProduct = (unsigned short)0, .bcdDevice_lo = (unsigned short)0, .bcdDevice_hi = (unsigned short)0, .bDeviceClass = (unsigned char)0, .bDeviceSubClass = (unsigned char)0, .bDeviceProtocol = (unsigned char)0, .bInterfaceClass = (unsigned char)0, .bInterfaceSubClass = (unsigned char)0, .bInterfaceProtocol = (unsigned char)0, .bInterfaceNumber = (unsigned char)0, .driver_info = 0UL}};

#line 560  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static struct usb_driver rsi_driver = {.name = "RSI-USB WLAN", .probe = & rsi_probe, .disconnect = & rsi_disconnect, .unlocked_ioctl = (int (*)(struct usb_interface *, unsigned int , void *))0, .suspend = & rsi_suspend, .resume = & rsi_resume, .reset_resume = (int (*)(struct usb_interface *))0, .pre_reset = (int (*)(struct usb_interface *))0, .post_reset = (int (*)(struct usb_interface *))0, .id_table = (struct usb_device_id const *)(& rsi_dev_table), .dynids = {.lock = {.__anonCompField_spinlock_18 = {.rlock = {.raw_lock = {.val = {.counter = 0}}, .magic = 0U, .owner_cpu = 0U, .owner = (void *)0, .dep_map = {.key = (struct lock_class_key *)0, .class_cache = {(struct lock_class *)0, (struct lock_class *)0}, .name = (char const *)0, .cpu = 0, .ip = 0UL}}}}, .list = {.next = (struct list_head *)0, .prev = (struct list_head *)0}}, .drvwrap = {.driver = {.name = (char const *)0, .bus = (struct bus_type *)0, .owner = (struct module *)0, .mod_name = (char const *)0, .suppress_bind_attrs = (_Bool)0, .probe_type = 0, .of_match_table = (struct of_device_id const *)0, .acpi_match_table = (struct acpi_device_id const *)0, .probe = (int (*)(struct device *))0, .remove = (int (*)(struct device *))0, .shutdown = (void (*)(struct device *))0, .suspend = (int (*)(struct device *, pm_message_t ))0, .resume = (int (*)(struct device *))0, .groups = (struct attribute_group const **)0, .pm = (struct dev_pm_ops const *)0, .p = (struct driver_private *)0}, .for_devices = 0}, .no_dynamic_id = 0U, .supports_autosuspend = 0U, .disable_hub_initiated_lpm = 0U, .soft_unbind = 0U};

#line 571  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
static int rsi_driver_init(void)
{
  int tmp;
  
#line 571 
  tmp = ldv_usb_register_driver_73(& rsi_driver,& __this_module,"rsi_usb");
...
#line 571 
  ldv_usb_deregister_74(& rsi_driver);
...
#line 576  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb.c"
struct usb_device_id const __mod_usb__rsi_dev_table_device_table[5U];

#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
struct usb_driver *ldv_emg_alias_rsi_driver_2 = & rsi_driver;
...
#line 65  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
int ldv_emg_wrapper_rsi_probe_5(struct usb_interface *arg0, struct usb_device_id *arg1)
{
  int tmp;
  
#line 66 
  tmp = rsi_probe(arg0,(struct usb_device_id const *)arg1);
...
#line 70  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
void ldv_emg_rsi_driver_exit(void)
{
...
#line 74  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
void ldv_emg_wrapper_rsi_disconnect_4(struct usb_interface *arg0)
{
...
#line 79  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
int ldv_emg_rsi_driver_init(void)
{
  int tmp;
...
#line 83  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
int ldv_emg_wrapper_rsi_resume_2(struct usb_interface *arg0)
{
  int tmp;
...
#line 88  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
int ldv_emg_wrapper_rsi_suspend_3(struct usb_interface *arg0, struct pm_message arg1)
{
  int tmp;
  
#line 89 
  tmp = rsi_suspend(arg0,arg1);
...
#line 101  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static long PTR_ERR(void const *ptr)
{
  long tmp;
...
#line 108  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static bool IS_ERR(void const *ptr)
{
  bool __retres;
  long ret;
...
#line 147  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static void atomic_inc(atomic_t *v)
{
...
#line 573  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static void *kmalloc(size_t size, gfp_t flags)
{
  void *tmp;
...
#line 594  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static void *kzalloc(size_t size, gfp_t flags)
{
  void *tmp;
...
#line 764  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static int ldv_usb_submit_urb_72(struct urb *ldv_func_arg1, gfp_t ldv_func_arg2)
{
  int tmp;
...
#line 772  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static int ldv_usb_register_driver_73(struct usb_driver *ldv_func_arg1, struct module *ldv_func_arg2, char const *ldv_func_arg3)
{
  int tmp;
...
#line 780  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb.c.aux"
static void ldv_usb_deregister_74(struct usb_driver *ldv_func_arg1)
{
...
#line 37  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb_ops.c.aux"
...
#line 86 
int rsi_read_pkt(struct rsi_common *, s32);


#line 33  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb_ops.c"
static int rsi_copy_to_card(struct rsi_common *common, u8 const *fw, u32 len, u32 num_blocks)
{
  int __retres;
  u32 indx;
  u32 ii;
...
#line 49 
  tmp = rsi_usb_write_register_multiple(adapter,lsb_address,(u8 *)(fw + indx),block_size);
  
#line 49 
  if (tmp != 0) {
    
#line 53 
    rsi_dbg(1U,"%s: Unable to load %s blk\n","rsi_copy_to_card",(char *)"rsi_91x.fw");
...
#line 64 
    tmp_0 = rsi_usb_write_register_multiple(adapter,lsb_address,(u8 *)(fw + indx),len % block_size);
...
#line 74 
  rsi_dbg(4U,"%s: Succesfully loaded %s instructions\n","rsi_copy_to_card",(char *)"rsi_91x.fw");
  
#line 78 
  rsi_dbg(4U,"%s: loaded firmware\n","rsi_copy_to_card");
...
#line 89  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb_ops.c"
void rsi_usb_rx_thread(struct rsi_common *common)
{
  int status;
  int tmp;
...
#line 98 
  tmp = atomic_read((atomic_t const *)(& dev->rx_thread.thread_done));
...
#line 104 
    rsi_dbg(1U,"%s: Failed To read data","rsi_usb_rx_thread");
...
#line 108 
  ldv_mutex_unlock_74(& common->tx_rxlock);
  
#line 109 
  rsi_reset_event(& dev->rx_thread.event);
  
#line 110 
  tmp_0 = (*(adapter->rx_urb_submit))(adapter);
  
#line 110 
  if (tmp_0 != 0) {
    
#line 111 
    rsi_dbg(1U,"%s: Failed in urb submission","rsi_usb_rx_thread");
...
#line 118 
  rsi_dbg(2U,"%s: Terminated thread\n","rsi_usb_rx_thread");
...
#line 132  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb_ops.c"
...
#line 142 
  status = request_firmware(& fw_entry,"rsi_91x.fw",adapter->device);
  
#line 143 
  if (status < 0) {
    
#line 144 
    rsi_dbg(1U,"%s Firmware file %s not found\n","rsi_load_ta_instructions",(char *)"rsi_91x.fw");
...
#line 150 
  fw = (u8 const *)kmemdup((void const *)fw_entry->data,fw_entry->size,208U);
...
#line 155 
  len = (unsigned int)fw_entry->size;
  
#line 157 
  if ((len & 3U) != 0U) 
#line 158 
                        len = (len & 4294967292U) + 4U; else ;
  
#line 160 
  num_blocks = len / block_size;
  
#line 162 
  rsi_dbg(4U,"%s: Instruction size:%d\n","rsi_load_ta_instructions",len);
  
#line 163 
  rsi_dbg(4U,"%s: num blocks: %d\n","rsi_load_ta_instructions",num_blocks);
...
#line 179  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/wireless/rsi/rsi_91x_usb_ops.c"
int rsi_usb_device_init(struct rsi_common *common)
{
  int __retres;
  int tmp;
...
#line 181 
  tmp = rsi_load_ta_instructions(common);
...
#line 731  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb_ops.c.aux"
static void ldv_mutex_lock_72(struct mutex *ldv_func_arg1)
{
...
#line 739  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb_ops.c.aux"
static void ldv_mutex_unlock_73(struct mutex *ldv_func_arg1)
{
...
#line 747  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/weaver/.tmp_rsi_91x_usb_ops.c.aux"
static void ldv_mutex_unlock_74(struct mutex *ldv_func_arg1)
{
...
#line 27  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
int main(void);
...
#line 36  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
pthread_t ldv_thread_5;

#line 40  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_emg_usb_deregister(struct usb_driver *arg0)
{
  
#line 43 
  struct usb_driver *ldv_4_usb_driver = ldv_emg_alias_rsi_driver_2;
...
#line 61  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 74  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_register_2_3(struct usb_driver *arg0)
{
  int ret;
...
#line 91  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_usb_scenario_5(void *arg0)
{
  void *__retres;
...
#line 97 
  struct usb_driver *ldv_5_container = ldv_emg_alias_rsi_driver_2;
...
#line 151 
    ldv_5_probe_retval = ldv_emg_wrapper_rsi_probe_5(ldv_5_resource,ldv_5_ldv_param_1_3);
...
#line 205 
        ldv_emg_wrapper_rsi_suspend_3(ldv_5_resource,*ldv_5_ldv_param_1_2);
...
#line 212 
        if (tmp_6 != 0) 
#line 215 
                        ldv_emg_wrapper_rsi_resume_2(ldv_5_resource);
        else 
...
#line 248 
    ldv_emg_wrapper_rsi_disconnect_4(ldv_5_resource);
...
#line 276  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
int ldv_emg_usb_register_driver(struct usb_driver *arg0, struct module *arg1, char *arg2)
{
  int __retres;
  int tmp_0;
...
#line 279 
  struct usb_driver *ldv_2_usb_driver = ldv_emg_alias_rsi_driver_2;
...
#line 311  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_deregister_4_1(struct usb_driver *arg0)
{
  int ret;
  struct ldv_struct_usb_scenario_5 *cf_arg_5;
...
#line 326  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
int ldv_emg_usb_submit_urb(struct urb *arg0, unsigned int arg1)
{
  int __retres;
...
#line 364  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/wireless/rsi/rsi_usb.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;
...
#line 371 
  ldv_1_ret = ldv_emg_rsi_driver_init();

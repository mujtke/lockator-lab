...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
...
#line 57  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/lg-vl600.c"
...
#line 63  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/lg-vl600.c"
struct vl600_state {
...
#line 68  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/lg-vl600.c"
...
#line 71 
  struct vl600_state *s = kzalloc(8UL,208U);
...
#line 98  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/lg-vl600.c"
...
#line 103 
                                                consume_skb(s->current_rx_buf); else ;
...
#line 110  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/lg-vl600.c"
...
#line 131 
    tmp = __le32_to_cpup((__le32 const *)(& frame->len));
    
#line 130 
    ;
    
#line 130 
    if (skb->len + (s->current_rx_buf)->len > tmp) {
      
#line 132 
      if ((dev->msg_enable & 32) != 0) 
#line 132 
                                       netdev_err((struct net_device const *)dev->net,"Fragment too long\n"); else ;
...
#line 138 
    tmp_0 = skb_put(buf,skb->len);
    
#line 138 
    memcpy((void *)tmp_0,(void const *)skb->data,(unsigned long)skb->len);
  }
  else 
...
#line 140 
      if ((dev->msg_enable & 32) != 0) 
#line 140 
                                       netdev_err((struct net_device const *)dev->net,"Frame too short\n"); else ;
...
#line 148 
  if (0 != 0) 
#line 148 
              tmp_2 = ((((frame->magic << 24) | ((frame->magic << 8) & 16711680U)) | ((frame->magic >> 8) & 65280U)) | (frame->magic >> 24)) != 1398031432U;
  else {
    __u32 tmp_1;
    
#line 148 
    tmp_1 = __fswab32(frame->magic);
    
#line 148 
    tmp_2 = tmp_1 != 1398031432U;
  }
...
#line 148 
    if (0 != 0) 
#line 148 
                tmp_4 = ((((frame->magic << 24) | ((frame->magic << 8) & 16711680U)) | ((frame->magic >> 8) & 65280U)) | (frame->magic >> 24)) != 1146375496U;
    else {
      __u32 tmp_3;
      
#line 149 
      tmp_3 = __fswab32(frame->magic);
      
#line 148 
      tmp_4 = tmp_3 != 1146375496U;
    }
...
#line 153 
    tmp_7 = __le32_to_cpup((__le32 const *)(& frame->len));
...
#line 159 
              tmp_5 = __le32_to_cpup((__le32 const *)(& frame->len));
              
#line 158 
              ;
              
#line 158 
              s->current_rx_buf = skb_copy_expand((struct sk_buff const *)skb,0,(int)tmp_5,32U);
...
#line 161 
                  tmp_6 = __le32_to_cpup((__le32 const *)(& frame->len));
                  
#line 161 
                  ;
                  
#line 161 
                  netdev_err((struct net_device const *)dev->net,"Reserving %i bytes ",tmp_6);
                }
                else ;
...
#line 170 
  tmp_8 = __le32_to_cpup((__le32 const *)(& frame->pkt_cnt));
...
#line 176 
    if ((dev->msg_enable & 32) != 0) 
#line 176 
                                     netdev_err((struct net_device const *)dev->net,"Packet too short\n"); else ;
...
#line 181 
  tmp_9 = __le32_to_cpup((__le32 const *)(& packet->len));
  
#line 181 
  packet_len = (int)(tmp_9 + 14U);
...
#line 183 
    if ((dev->msg_enable & 32) != 0) 
#line 183 
                                     netdev_err((struct net_device const *)dev->net,"Bad packet length stored in header\n"); else ;
...
#line 194 
  tmp_10 = __be16_to_cpup((__be16 const *)(& ethhdr->h_proto));
  
#line 194 
  if ((unsigned int)tmp_10 == 2054U) {
    
#line 194 
    if (buf->len > 38U) {
      
#line 197 
      memcpy((void *)(& ethhdr->h_source),(void const *)(buf->data + 22U),6UL);
      
#line 200 
      memcpy((void *)(& ethhdr->h_dest),(void const *)(buf->data + 32U),6UL);
    }
    else 
#line 194 
         goto _LAND;
...
#line 205 
             memcpy((void *)(& ethhdr->h_dest),(void const *)(dev->net)->dev_addr,6UL);
             
#line 212 
             if (((int)*(buf->data + 14U) & 240) == 96) 
#line 213 
                                                        ethhdr->h_proto = (unsigned short)56710U; else ;
           }
  }
...
#line 248  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/usb/lg-vl600.c"
...
#line 277 
      skb->data = (unsigned char *)memmove((void *)(skb->head + 24U),(void const *)skb->data,(unsigned long)skb->len);
...
#line 285 
  ret = skb_copy_expand((struct sk_buff const *)skb,24,(int)(((unsigned int)full_len - skb->len) + 4294967272U),flags);
...
#line 314 
                                         skb_put(skb,(unsigned int)full_len - skb->len); else ;
...
#line 349 
  ldv_usb_deregister_73(& lg_vl600_driver);
...
#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
int (*ldv_emg_alias_usbnet_resume_2)(struct usb_interface *) = & usbnet_resume;

#line 57  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
int (*ldv_emg_alias_usbnet_suspend_3)(struct usb_interface *, struct pm_message ) = & usbnet_suspend;

#line 58  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
struct usb_driver *ldv_emg_alias_lg_vl600_driver_2 = & lg_vl600_driver;

#line 59  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
void (*ldv_emg_alias_usbnet_disconnect_4)(struct usb_interface *) = & usbnet_disconnect;

#line 60  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
...
#line 68  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
int ldv_emg_lg_vl600_driver_init(void)
{
  int tmp;
  
#line 69 
  tmp = lg_vl600_driver_init();
...
#line 72  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
void ldv_emg_lg_vl600_driver_exit(void)
{
...
#line 430  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
static void *kzalloc(size_t size, gfp_t flags)
{
  void *tmp;
...
#line 747  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
static int ldv_usb_register_driver_72(struct usb_driver *ldv_func_arg1, struct module *ldv_func_arg2, char const *ldv_func_arg3)
{
  int tmp;
...
#line 755  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/weaver/.tmp_lg-vl600.c.aux"
static void ldv_usb_deregister_73(struct usb_driver *ldv_func_arg1)
{
...
#line 26  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
...
#line 35  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
pthread_t ldv_thread_4;

#line 39  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_register_3_3(struct usb_driver *arg0)
{
  int ret;
...
#line 56  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 69  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
int ldv_emg_usb_register_driver(struct usb_driver *arg0, struct module *arg1, char *arg2)
{
  int __retres;
  int tmp_0;
...
#line 72 
  struct usb_driver *ldv_3_usb_driver = ldv_emg_alias_lg_vl600_driver_2;
...
#line 104  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_usb_scenario_4(void *arg0)
{
  void *__retres;
...
#line 110 
  struct usb_driver *ldv_4_container = ldv_emg_alias_lg_vl600_driver_2;
...
#line 289  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_dispatch_deregister_2_1(struct usb_driver *arg0)
{
  int ret;
  struct ldv_struct_usb_scenario_4 *cf_arg_4;
...
#line 304  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
void ldv_emg_usb_deregister(struct usb_driver *arg0)
{
  
#line 307 
  struct usb_driver *ldv_2_usb_driver = ldv_emg_alias_lg_vl600_driver_2;
...
#line 325  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/usb/lg-vl600.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;
...
#line 332 
  ldv_1_ret = ldv_emg_lg_vl600_driver_init();

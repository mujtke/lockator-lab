...
#line 14  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/phy/ste10Xp.ko/linux:concurrency safety/weaver/.tmp_ste10Xp.c.aux"
...
#line 35  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/phy/ste10Xp.c"
...
#line 56  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/phy/ste10Xp.c"
...
#line 75  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/phy/ste10Xp.c"
...
#line 84  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/phy/ste10Xp.c"
static struct phy_driver ste10xp_pdriver[2U] = {{.phy_id = 400464U, .name = (char *)"STe101p", .phy_id_mask = 4294967280U, .features = 8911U, .flags = 1U, .driver_data = (void const *)0, .soft_reset = (int (*)(struct phy_device *))0, .config_init = & ste10Xp_config_init, .probe = (int (*)(struct phy_device *))0, .suspend = & genphy_suspend, .resume = & genphy_resume, .config_aneg = & genphy_config_aneg, .aneg_done = (int (*)(struct phy_device *))0, .read_status = & genphy_read_status, .ack_interrupt = & ste10Xp_ack_interrupt, .config_intr = & ste10Xp_config_intr, .did_interrupt = (int (*)(struct phy_device *))0, .remove = (void (*)(struct phy_device *))0, .match_phy_device = (int (*)(struct phy_device *))0, .ts_info = (int (*)(struct phy_device *, struct ethtool_ts_info *))0, .hwtstamp = (int (*)(struct phy_device *, struct ifreq *))0, .rxtstamp = (bool (*)(struct phy_device *, struct sk_buff *, int ))0, .txtstamp = (void (*)(struct phy_device *, struct sk_buff *, int ))0, .set_wol = (int (*)(struct phy_device *, struct ethtool_wolinfo *))0, .get_wol = (void (*)(struct phy_device *, struct ethtool_wolinfo *))0, .link_change_notify = (void (*)(struct phy_device *))0, .read_mmd_indirect = (int (*)(struct phy_device *, int , int , int ))0, .write_mmd_indirect = (void (*)(struct phy_device *, int , int , int , u32 ))0, .module_info = (int (*)(struct phy_device *, struct ethtool_modinfo *))0, .module_eeprom = (int (*)(struct phy_device *, struct ethtool_eeprom *, u8 *))0, .driver = {.name = (char const *)0, .bus = (struct bus_type *)0, .owner = & __this_module, .mod_name = (char const *)0, .suppress_bind_attrs = (_Bool)0, .probe_type = 0, .of_match_table = (struct of_device_id const *)0, .acpi_match_table = (struct acpi_device_id const *)0, .probe = (int (*)(struct device *))0, .remove = (int (*)(struct device *))0, .shutdown = (void (*)(struct device *))0, .suspend = (int (*)(struct device *, pm_message_t ))0, .resume = (int (*)(struct device *))0, .groups = (struct attribute_group const **)0, .pm = (struct dev_pm_ops const *)0, .p = (struct driver_private *)0}}, {.phy_id = 470024209U, .name = (char *)"STe100p", .phy_id_mask = 4294967295U, .features = 8911U, .flags = 1U, .driver_data = (void const *)0, .soft_reset = (int (*)(struct phy_device *))0, .config_init = & ste10Xp_config_init, .probe = (int (*)(struct phy_device *))0, .suspend = & genphy_suspend, .resume = & genphy_resume, .config_aneg = & genphy_config_aneg, .aneg_done = (int (*)(struct phy_device *))0, .read_status = & genphy_read_status, .ack_interrupt = & ste10Xp_ack_interrupt, .config_intr = & ste10Xp_config_intr, .did_interrupt = (int (*)(struct phy_device *))0, .remove = (void (*)(struct phy_device *))0, .match_phy_device = (int (*)(struct phy_device *))0, .ts_info = (int (*)(struct phy_device *, struct ethtool_ts_info *))0, .hwtstamp = (int (*)(struct phy_device *, struct ifreq *))0, .rxtstamp = (bool (*)(struct phy_device *, struct sk_buff *, int ))0, .txtstamp = (void (*)(struct phy_device *, struct sk_buff *, int ))0, .set_wol = (int (*)(struct phy_device *, struct ethtool_wolinfo *))0, .get_wol = (void (*)(struct phy_device *, struct ethtool_wolinfo *))0, .link_change_notify = (void (*)(struct phy_device *))0, .read_mmd_indirect = (int (*)(struct phy_device *, int , int , int ))0, .write_mmd_indirect = (void (*)(struct phy_device *, int , int , int , u32 ))0, .module_info = (int (*)(struct phy_device *, struct ethtool_modinfo *))0, .module_eeprom = (int (*)(struct phy_device *, struct ethtool_eeprom *, u8 *))0, .driver = {.name = (char const *)0, .bus = (struct bus_type *)0, .owner = & __this_module, .mod_name = (char const *)0, .suppress_bind_attrs = (_Bool)0, .probe_type = 0, .of_match_table = (struct of_device_id const *)0, .acpi_match_table = (struct acpi_device_id const *)0, .probe = (int (*)(struct device *))0, .remove = (int (*)(struct device *))0, .shutdown = (void (*)(struct device *))0, .suspend = (int (*)(struct device *, pm_message_t ))0, .resume = (int (*)(struct device *))0, .groups = (struct attribute_group const **)0, .pm = (struct dev_pm_ops const *)0, .p = (struct driver_private *)0}}};

#line 115  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/phy/ste10Xp.c"
static int phy_module_init(void)
{
  int tmp;
  
#line 115 
  tmp = phy_drivers_register((struct phy_driver *)(& ste10xp_pdriver),2);
...
#line 123  "/home/debian/klever-inst/klever/build bases/linux-4.2.6/Storage/home/debian/klever-inst/tmp-dir/linux-4.2.6/drivers/net/phy/ste10Xp.c"
struct mdio_device_id const __mod_mdio__ste10Xp_tbl_device_table[3U];

#line 57  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/phy/ste10Xp.ko/linux:concurrency safety/weaver/.tmp_ste10Xp.c.aux"
...
#line 61  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/phy/ste10Xp.ko/linux:concurrency safety/weaver/.tmp_ste10Xp.c.aux"
...
#line 15  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/phy/ste10Xp.ko/linux:concurrency safety/emg/environment_model.c"
int main(void);
...
#line 20  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/phy/ste10Xp.ko/linux:concurrency safety/emg/environment_model.c"
int main(void)
{
  int __retres;
...
#line 33  "/home/debian/klever-inst/klever-work/native-scheduler/scheduler/jobs/91e514eede894122cca4a9df4375a888/klever-core-work-dir/job/vtg/drivers/net/phy/ste10Xp.ko/linux:concurrency safety/emg/environment_model.c"
void *ldv_initialization_1(void *arg0)
{
  void *__retres;
  int ldv_1_ret;

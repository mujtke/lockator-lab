...
public class ThreadState
  ...
  @Override
  public boolean cover(CompatibleNode pNode) {  // 应该是按照CREATED_THREAD < PARENT_THREAD的顺序
  ...
  @Override
  public Delta<CompatibleNode> getDeltaBetween(CompatibleNode pOther) {   // 获取两个CompatibleNode的ThreadSet的相交部分

...
public class GlobalAccessChecker {
    ...
    private Boolean hasGlobalAccessDirect(AAstNode ast) {
        ...
        if (ast instanceof CRightHandSide) {
            ...
            if (ast instanceof CExpression) {
                return ((CExpression) ast).accept(org.sosy_lab.cpachecker.cpa.ThreadingForPlanC.GlobalAccessChecker.GlobalAccessVisitor.INSTANCE);
    ...
    private static class GlobalAccessVisitor
        ...
        final static org.sosy_lab.cpachecker.cpa.ThreadingForPlanC.GlobalAccessChecker.GlobalAccessVisitor INSTANCE = new org.sosy_lab.cpachecker.cpa.ThreadingForPlanC.GlobalAccessChecker.GlobalAccessVisitor();

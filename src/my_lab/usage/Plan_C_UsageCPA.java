...
public class Plan_C_UsageCPA extends AbstractSingleWrapperCPA
        implements ConfigurableProgramAnalysisWithBAM, ConfigurableProgramAnalysisTM,
        StatisticsProvider {

    private final StopOperator stopOperator;
    private final MergeOperator mergeOperator;
    private final Plan_C_UsageTransferRelation transferRelation;
    ...
    public static CPAFactory factory() {
        return AutomaticCPAFactory.forType(my_lab.usage.Plan_C_UsageCPA.class);
    }
    ...
    private Plan_C_UsageCPA(
        ...
        this.statistics =
                new Plan_C_UsageCPAStatistics(
                        pConfig,
                        pLogger,
                        pCfa,
                        lockCPA != null ? (LockTransferRelation) lockCPA.getTransferRelation() : null);
        this.stopOperator = new Plan_C_UsageStopOperator(pCpa.getStopOperator(), statistics);
        this.mergeOperator =
                new Plan_C_UsageMergeOperator(pCpa.getMergeOperator(), statistics, bindArgsFunctions);

        this.precisionAdjustment =
                new Plan_C_UsagePrecisionAdjustment(pCpa.getPrecisionAdjustment(), statistics);
        logger = pLogger;
        ...
        this.transferRelation =
                new Plan_C_UsageTransferRelation(
    ...
    public Plan_C_UsageCPAStatistics getStats() {
        return statistics;
    }
    ...
    public Plan_C_UsageProcessor getUsageProcessor() {
    ...
    public ApplyOperator getApplyOperator() {
        return new Plan_C_UsageApplyOperator(

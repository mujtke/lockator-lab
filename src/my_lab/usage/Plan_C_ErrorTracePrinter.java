...
public abstract class Plan_C_ErrorTracePrinter {
    ...
    private static class TraceCore {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore)) {
                return false;
            }
            my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore other = (my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore) obj;
    ...
    protected Plan_C_UsageContainer container;

    protected Predicate<CFAEdge> FILTER_EMPTY_FILE_LOCATIONS;
    private final BAMMultipleCEXSubgraphComputer subgraphComputer;

    private final Map<Set<my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore>, AbstractIdentifier> printedTraces;

    protected Plan_C_ErrorTracePrinter(
            Configuration c,
        ...
        config = c;
        lockTransfer = lT;
        config.inject(this, my_lab.usage.Plan_C_ErrorTracePrinter.class);
    ...
    public void printErrorTraces(Plan_C_UsageReachedSet uReached) {
    ...
    private boolean shouldBeSkipped(Pair<UsageInfo, UsageInfo> pTmpPair, AbstractIdentifier id) {
        ...
        my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore first = new my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore(pTmpPair.getFirst());
        my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore second = new my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore(pTmpPair.getSecond());

        Set<my_lab.usage.Plan_C_ErrorTracePrinter.TraceCore> trace = Sets.newHashSet(first, second);
